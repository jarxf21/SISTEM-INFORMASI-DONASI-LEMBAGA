    ...
    <div class="max-w-7xl mx-auto p-4 lg:p-6">    
        ...
        <header class="relative bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl overflow-hidden mb-8">
            ...
            <div class="relative z-10 text-center py-24 px-6">
                ...
                <p class="text-xl text-gray-200 max-w-2xl mx-auto">Kegiatan Yang di lakukan Lembaga Sahabat Ummat</p>
            </div>
        </header>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <article class="bg-white rounded-xl shadow-sm p-6 mb-8">
                <img src="{{ asset('storage/' . $item->dokumentasi_kegiatan) }}" alt="Artikel Unggulan" class="w-full h-64 object-cover rounded-lg mb-6">
                ...
                <p class="text-gray-600 text-lg leading-relaxed mb-6">{{ Str::limit(strip_tags($item->deskripsi_lengkap), 150) }}</p>
